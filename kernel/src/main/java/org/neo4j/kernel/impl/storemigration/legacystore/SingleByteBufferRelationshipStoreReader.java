...
public class SingleByteBufferRelationshipStoreReader implements RelationshipStoreReader
{
    ...
    public SingleByteBufferRelationshipStoreReader( String fileName ) throws IOException
    {
